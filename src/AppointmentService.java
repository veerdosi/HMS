...
public class AppointmentService {
    ...
    /**
     * Constructs an AppointmentService with the provided DoctorService and PatientService.
     * Initializes the AppointmentOutcomeRecord and DoctorAvailabilityRepository.
     *
     * @param doctorService The service managing doctor-related operations.
     * @param patientService The service managing patient-related operations.
     */
    ...
    /**
     * Schedules an appointment for a given patient with a specified doctor and datetime.
     * Validates the inputs, checks availability, and updates necessary records.
     *
    ...
    /**
     * Cancels an appointment by its ID. Updates the doctor's schedule and appointment status.
     *
     ...
     * Updates the status and adjusts doctor availability accordingly.
     *
     * @param appointmentId The ID of the appointment to process.
     * @param accept A boolean indicating whether to confirm (true) or decline (false) the appointment.
     */
     ...
     * Ensures the new time slot is available and updates the appointment record.
     *
    ...
    /**
     * Adds consultation notes to a specific appointment. Automatically marks the appointment
     * as completed if both notes and prescriptions are present.
     *
    ...
    /**
     * Sets the type of service for a specific appointment.
     *
     * @param appointmentId The ID of the appointment to update.
    ...
    /**
     * Adds a prescription to a specific appointment. Automatically marks the appointment
     * as completed if both notes and prescriptions are present.
     *
     * @param appointmentId The ID of the appointment to update.
     * @param prescription The prescription to add to the appointment.
     */
