...
/**
 * The `PatientMenu` class provides an interactive menu for patients to manage
 * appointments, update personal information, and reset passwords.
 *
 * It interacts with the `AppointmentServiceFacade` and `AppointmentOutcomeRecord`
 * for appointment-related operations and uses the `PatientInfoUpdater` for managing
 * personal information updates. The menu offers various functionalities like
 * viewing medical records, scheduling or rescheduling appointments, and viewing past outcomes.
 *
 */
public class PatientMenu {
    ...
    /**
     * Resets the patient's password by prompting for a new password.
     */
