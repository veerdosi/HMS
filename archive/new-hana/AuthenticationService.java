    ...
    private void loadPatients() {
        try (BufferedReader br = new BufferedReader(new FileReader(PATIENT_FILE_PATH))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                Patient patient = new Patient(patientID, name, password, contactInfo, dateOfBirth, gender, bloodType);
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(STAFF_FILE_PATH))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                switch (role.toLowerCase()) {
                    case "doctor":
                        user = new Doctor(staffID, name, password, age, gender);
                        break;
                    case "pharmacist":
                        user = new Pharmacist(staffID, name, password, age, gender);
                        break;
                    case "administrator":
                        user = new Admin(staffID, name,  password, age, gender);
                        break;
                    default:
