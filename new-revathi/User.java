...
public class User {
    ...
    // Constructor
    public User(String userID, String password, String name,String contactNumber, String email, UserRole role, String gender) {
        this.userID = userID;
    ...
    //Check if user is Doctor or admin for priviledged access
    public boolean isDoctor() {
        return UserRole.isDoctor(this.role);
    }
